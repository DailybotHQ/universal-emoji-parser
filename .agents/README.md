...
| `/write-tests`          | Author Vitest tests for a parsing bug or new feature                       | [commands/write-tests.md](commands/write-tests.md)                   |
| `/fix-build`            | Diagnose a failing TypeScript / Vite / Vitest build                        | [commands/fix-build.md](commands/fix-build.md)                       |
...
| `test-author`        | Vitest specs, regression tests, regenerator handling           | [agents/test-author.md](agents/test-author.md)               |
...
| `release-engineer`   | Vite config, GitHub Actions, npm publish, GitHub releases       | [agents/release-engineer.md](agents/release-engineer.md)     |
