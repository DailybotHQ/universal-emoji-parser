...
| `typescript-strict-style`  | TS rules enforced by `tsconfig.json` + ESLint flat config                                                                                                                                                                  |
...
| `test-author`        | Writes Mocha + Chai specs, regression cases, integration coverage                  |
