...
describe('Test emoji parser', () => {
  describe('Using default options', () => {
    ...
    it('Test emoji parser translating emojis unicodes to shortcodes', () => {
      ...
      text = '😎'
      result = uEmojiParser.parseToShortcode(text)
      expect(result).toBe(':smiling_face_with_sunglasses:')
    })
  ...
  describe('Coffee Tests', () => {
    it('should parse emojis about coffee', () => {
      ...
      expect(result).toBe('Coffee emojis: ☕ 🤎 ☕ 🤎')
    })
  })
  ...
  describe('Heart Tests', () => {
    it('should parse emojis about heart', () => {
      ...
      expect(result).toBe('Heart emojis: ❤️ 💘 ❤️ 💘')
    })
  })
  ...
  describe('Readme tests', () => {
    ...
    it('should parse tests using method options', () => {
      ...
      expect(result).toBe('Hello world! :smiling_face_with_sunglasses: :rocket:')
  ...
  describe('GitHub-style aliases', () => {
    it('should parse :+1: and :-1: shortcodes', () => {
      ...
      expect(uEmojiParser.parseToUnicode(':+1:')).toBe('👍')
      expect(uEmojiParser.parseToUnicode(':-1:')).toBe('👎')
      expect(uEmojiParser.parseToUnicode('lgtm :+1:')).toBe('lgtm 👍')
      expect(uEmojiParser.parseToUnicode(':+1: :+1:')).toBe('👍 👍')
    })
    ...
    it('should resolve :100: to 💯', () => {
      ...
      expect(uEmojiParser.parseToUnicode(':100:')).toBe('💯')
    })
